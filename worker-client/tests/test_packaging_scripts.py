...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_windows_ci_publishes_a_verified_portable_zip(self):
        ...
        self.assertIn("chejin-worker-v0.9.6-windows-x64.delivery.json", workflow)
    ...
    def test_omniauto_provenance_records_merged_upstream_and_history(
        ...
        self.assertEqual(
            ...
            [
                {
                    "source_commit": (
                        "4260e1efcc8d78d7ba24ee9c28e28406d923832e"
                    ),
                    "scope": [
                        ...
                        "c2_contract_0_9_6_generated_schema",
        ...
        self.assertIn("0.9.6", provenance["integration_note"])
    ...
    def test_windows_package_ci_builds_and_probes_the_frozen_executable(self):
        ...
        self.assertIn('version -ne "0.9.6"', workflow)

...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_windows_ci_publishes_a_verified_portable_zip(self):
        ...
        self.assertIn("chejin-worker-v0.9.18-windows-x64.delivery.json", workflow)
    ...
    def test_omniauto_provenance_records_merged_upstream_and_history(
        ...
        self.assertEqual(
            ...
            [
                {
                    "source_commit": (
                        "80b07ef38d862ec5dccbff33646450724fd3c2c3"
                    ),
                    "scope": [
                        ...
                        "c2_contract_0_9_18_generated_schema",
                        (
        ...
        self.assertIn("0.9.18", provenance["integration_note"])
    ...
    def test_windows_package_ci_builds_and_probes_the_frozen_executable(self):
        ...
        self.assertIn('version -ne "0.9.18"', workflow)

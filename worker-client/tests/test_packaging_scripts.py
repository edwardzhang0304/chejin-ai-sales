...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_build_script_writes_manifest_and_checks_sidecar(self):
        ...
        self.assertIn("https://jiangsuchejin.com/api", text)
        self.assertIn("default_api_base_url = $DefaultApiBaseUrl.Trim()", text)
    ...
    def test_windows_ci_publishes_a_verified_portable_zip(self):
        ...
        self.assertIn("chejin-worker-v0.9.69-windows-x64.delivery.json", workflow)
        ...
        self.assertIn("chejin-worker-v0.9.69-windows-x64.release.json", workflow)
    ...
    def test_fast_uat_workflow_reuses_runtime_and_probes_extracted_zip(self):
        ...
        self.assertNotIn(
            "CHEJIN_WORKER_HOME: ${{ runner.temp }}", workflow
        )
        self.assertIn(
        ...
        self.assertIn(
            "Run affected Brain context and Provider-input tests",
            workflow,
        )
    ...
    def test_omniauto_provenance_records_merged_upstream_and_history(
            ...
            [
                {
                    ...
                    "scope": [
                        ...
                        "c2_contract_0_9_48_generated_schema",
                        "c2_contract_0_9_49_generated_schema",
                        (
                            "business_viewport_geometry_independent_"
                            "continuity_contract"
                        ),
                        "media_action_frame_receipt_binding_contract",
                        (
                            "pillow_flattened_pixel_iteration_"
                            "compatibility_contract"
                        ),
                        "c2_contract_0_9_50_generated_schema",
                        (
                        ...
                        (
                            "chejin_message_event_authoritative_brain_"
                            "context_contract"
                        ),
                        "c2_contract_0_9_53_generated_schema",
                        ...
                        (
                            "chejin_immutable_knowledge_release_"
                            "projection_contract"
                        ),
                        (
                            "chejin_frozen_history_managed_knowledge_"
                            "query_contract"
                        ),
                        (
                            "chejin_legacy_knowledge_runtime_side_door_"
                            "removal_contract"
                        ),
                        "c2_contract_0_9_61_generated_schema",
                        "c2_contract_0_9_63_generated_schema",
                        "c2_contract_0_9_64_generated_schema",
                        "frame_local_independent_avatar_evidence_contract",
        ...
        self.assertIn("0.9.56", provenance["integration_note"])
        self.assertIn(
    ...
    def test_windows_package_ci_builds_and_probes_the_frozen_executable(self):
        ...
        self.assertIn('version -ne "0.9.69"', workflow)
        ...
        self.assertIn("chejin-worker-production-endpoint-preflight.json", workflow)
        self.assertIn("https://jiangsuchejin.com/readyz", workflow)
        self.assertIn("packaged client does not default to the production backend", workflow)

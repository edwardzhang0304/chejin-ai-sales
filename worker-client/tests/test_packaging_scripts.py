...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_windows_ci_publishes_a_verified_portable_zip(self):
        ...
        self.assertIn("chejin-worker-v0.9.15-windows-x64.delivery.json", workflow)
    ...
    def test_omniauto_provenance_records_merged_upstream_and_history(
        ...
        self.assertEqual(
            ...
            [
                {
                    "source_commit": (
                        "9c45ad157a9314605333ae76d29e4a0211356656"
                    ),
                    "scope": [
                        ...
                        "c2_contract_0_9_15_generated_schema",
        ...
        self.assertIn("0.9.15", provenance["integration_note"])
        self.assertIn(
    ...
    def test_windows_package_ci_builds_and_probes_the_frozen_executable(self):
        ...
        self.assertIn('version -ne "0.9.15"', workflow)

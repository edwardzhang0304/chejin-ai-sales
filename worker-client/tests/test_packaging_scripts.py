...
class PackagingScriptsTest(unittest.TestCase):
    ...
    def test_windows_ci_publishes_a_verified_portable_zip(self):
        ...
        self.assertIn("chejin-worker-v0.9.41-windows-x64.delivery.json", workflow)
    ...
    def test_omniauto_provenance_records_merged_upstream_and_history(
        ...
        self.assertEqual(
            ...
            [
                {
                    "source_commit": (
                        "54f8c1bccd15aa7968c634e7732f4baca1dc36da"
                    ),
                    "scope": [
        ...
        self.assertIn("0.9.41", provenance["integration_note"])
        self.assertIn(
    ...
    def test_windows_package_ci_builds_and_probes_the_frozen_executable(self):
        ...
        self.assertIn('version -ne "0.9.41"', workflow)

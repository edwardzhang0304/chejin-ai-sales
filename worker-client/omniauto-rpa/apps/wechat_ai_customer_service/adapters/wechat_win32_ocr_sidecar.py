...
STARTUP_CALIBRATION_PATH = Path(
    ...
    or (PROJECT_ROOT / "runtime" / "wechat_startup_layout_calibration_v0.9.30.json")
)
...
def run_action(args: argparse.Namespace) -> dict[str, Any]:
    ...
    # v0.9.30 has exactly one geometry owner: the startup normalize action.
...
def build_and_store_startup_calibration(
    ...
    *,
    ...
    """Capture one exact client frame and build the sole v0.9.30 shell map."""

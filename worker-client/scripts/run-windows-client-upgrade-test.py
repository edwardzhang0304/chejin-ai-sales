"""Exercise the shipped 0.9.72 GUI and updater against the exact signed ZIP.
...
def run_case(args, status):
    ...
    processes = []
    report = {"current_version": "0.9.72", "target_version": "0.9.73", "initial_run_status": status,
    ...
    try:
        ...
        with QtPage(debug_port) as page:
            ...
            assert plan["schema_version"] == 2 and plan["current_version"] == "0.9.72"
            ...
            assert marker["healthy"] is True and marker["version"] == "0.9.73"
...
def main():
    ...
    print("Original 0.9.72 GUI -> signed 0.9.73: paused and faulted cases passed")

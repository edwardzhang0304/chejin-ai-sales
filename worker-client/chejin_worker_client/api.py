...
from .failure_evidence import api_failure_evidence
...
class WorkerApiClient:
    ...
    def get_vision_credential(self, binding: Binding) -> str:
        ...
        with api_failure_evidence("GET", f"/workers/{binding.worker_id}/vision-credential"):
    ...
    def post_observability_stage_events(
        ...
        *,
        ...
        with api_failure_evidence("POST", f"/workers/{binding.worker_id}/observability/stage-events"):
            headers = {
    ...
    def _request(
        ...
        *,
        ...
        with api_failure_evidence(method, path):

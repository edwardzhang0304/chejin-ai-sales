...
class Worker(Base, TimestampMixin):
    ...
    vision_api_key_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
    vision_credential_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    vision_credential_updated_by: Mapped[str | None] = mapped_column(String(36), nullable=True)

...
| 项目 | 当前值 |
|---|---|
| 候选工作区 | `codex/gray-release-0.9.x`；`0.9.32` 为未过审的历史本地实现；`0.9.33` 架构复审已通过，真实功能提交固定于 `61606d645de2c575ad3113de577e0f90d87a41f0`，当前进行来源治理收口 |
...
| 当前机器合同 | Worker、Sidecar、后端和生成 Schema 已统一为 `contract_revision=0.9.33`，规范化 SHA `44fd053283d6af73fb945759db5f1ccb6d91ea479954d27990e24b485bed2b8e`；不得与已发布 `0.9.31` 混跑 |
| 来源治理 | `0.9.33` 真实功能提交已固定为 `61606d645de2c575ad3113de577e0f90d87a41f0`，`.chejin-source.json` 已绑定该提交；来源治理提交尚未形成 |
| PRD | v0.9.10 |
...
| 发布状态 | `0.9.32` 因首次媒体动作循环身份门禁作废。`0.9.33` 代码层架构复审已通过并形成真实功能提交；来源治理提交、推送、标签、打包和 Windows UAT 尚未完成 |

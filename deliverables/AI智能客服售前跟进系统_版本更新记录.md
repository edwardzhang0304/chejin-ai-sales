...
| 项目 | 当前值 |
|---|---|
| 候选工作区 | `codex/gray-release-0.9.x`；`0.9.34` 已打 `gray-v0.9.34` 标签并生成过 ZIP，不得覆盖；`0.9.35` 真实功能提交已固定为 `e97ca89613ca8478e626e06fd8a42a13f8c96747` |
...
| 来源治理 | `.chejin-source.json` 已绑定 `0.9.35` 真实功能提交 `e97ca89613ca8478e626e06fd8a42a13f8c96747`；当前待形成来源治理提交 |
| PRD | v0.9.10 |
...
- 本轮不修改 C0—C4、媒体动作顺序、Brain/Guard、Handoff、UI 锁、后端接口或发送回执流程；真实功能提交已固定为 `e97ca89613ca8478e626e06fd8a42a13f8c96747` 并完成来源绑定，来源治理提交、推送、标签、ZIP、GitHub Windows 完整门禁和 Windows 实机 UAT 均未完成。

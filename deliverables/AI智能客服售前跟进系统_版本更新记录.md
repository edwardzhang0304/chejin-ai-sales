...
| 来源治理 | 独立 OmniAuto 固定提交 `97512010bb36c2d902db03b1b64705b2a01d9b65` 已形成，`.chejin-source.json` 已回填真实提交号与 `0.9.22` scope；待按双仓顺序推送 |
| PRD | v0.9.10 |
...
- 按“任何内容变化必须升版”的不可覆盖规则，候选整体升为 `0.9.22`；合同 SHA 为 `1a07dde94d270676cde4e6f1e0af3dcc071f4efedbb66c866c06cd64b36a5d39`，本次复审后 OmniAuto 固定提交为 `97512010bb36c2d902db03b1b64705b2a01d9b65`。
...
- 1920 级分辨率下窗口保持约 `980×860`，125%/150% DPI 只用于坐标和诊断，不再放大窗口；2K/4K 仍按实际物理分辨率档位调整。

...
2. `AI智能客服售前跟进系统_技术方案手册_v0.9.57.md`
3. 本版本更新记录
...
| 项目 | 当前值 |
|---|---|
| 候选工作区 | 灰度分支 `codex/gray-release-0.9.x`；当前功能提交 `f63613a51157c480a442e996ea8b211b3ba484fe` |
| 本轮整改父基线 | `0.9.56` 提交 `3da3dc9ebde882d83d043cfa2c58458898981fe7`；原始生产能力底座仍为 `b6ad192`（`gray-v0.9.43`） |
| 灰度版本 | `0.9.57`；机器合同、生成 Schema、独立 OmniAuto 来源和车金候选均已形成 |
...
| 当前机器合同 | `contract_revision=0.9.57`；规范化 SHA `c978438ece0b9e950fe234f1366b4074635200886b5e2872d50f6bb84944c4be` |
| 来源治理 | `.chejin-source.json` 已绑定独立 OmniAuto 真实提交 `c9d9ac5e80c571db9a35ff05c299c814a9d25999` |
| PRD | v0.9.50；本轮不改变业务需求，无需为技术互斥修复升版 |
| 技术方案 | v0.9.57；是当前唯一技术口径 |
| 全流程图 | v0.9.57；是当前唯一流程口径 |
| 发布状态 | 0.9.57 灰度与回滚分支已形成；本机仅保留 0.9.57 ZIP，旧 ZIP 和旧 UAT 文档已删除 |

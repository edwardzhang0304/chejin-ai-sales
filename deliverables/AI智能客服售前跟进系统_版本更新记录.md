...
| 当前机器合同 | 本地待复审实现已统一为 `contract_revision=0.9.31`，规范化 SHA `74b66af403e007a8739a4b22c18bbfa4d9ba0a38838150a15144e0337a5f7f26`；生成 Schema 已同步，真实功能提交尚未形成 |
| 来源治理 | `0.9.30` 候选提交 `5c94a91cd956f37776be73f872b4c34ccaccd810` 只作审计和回滚基线，禁止作为发布包；`0.9.31` 真实功能提交和来源绑定待实现后形成 |
| PRD | v0.9.10 |
...
| 发布状态 | `0.9.30` 架构批准已撤回，禁止继续使用。`0.9.31` 本地代码与定向自动测试已完成，待架构复审、真实功能提交/来源绑定及 Windows 原故障 SQLite 重启验收；当前未提交、未推送、未打包、未部署 |

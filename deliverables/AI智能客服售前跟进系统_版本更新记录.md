...
| 项目 | 当前值 |
|---|---|
| 候选工作区 | `codex/gray-release-0.9.x`；`0.9.33` 已打 `gray-v0.9.33` 标签并生成过 ZIP，不得覆盖；`0.9.34` 真实功能提交已固定为 `11d43d5bb9dd83831e0bbba8ed84b5eba700cb2c` |
...
| 来源治理 | `.chejin-source.json` 已绑定 `0.9.34` 真实功能提交 `11d43d5bb9dd83831e0bbba8ed84b5eba700cb2c`；当前待形成来源治理提交 |
| PRD | v0.9.10 |
...
| 发布状态 | `0.9.33` 已有标签和 ZIP，本次修复不得覆盖。`0.9.34` 代码、四入口回归和文档架构复审已通过，功能提交已固定；尚未推送、标签、打包或 Windows UAT |

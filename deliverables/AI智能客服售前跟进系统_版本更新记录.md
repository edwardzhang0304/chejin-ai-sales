...
| 来源治理 | 独立 OmniAuto 固定提交 `0510999859e2e174cfa3cc4a8cc39e9170f92ec9` 已形成，`.chejin-source.json` 已回填真实提交号与 `0.9.22` scope；待按双仓顺序推送 |
| PRD | v0.9.10 |
...
- 按“任何内容变化必须升版”的不可覆盖规则，候选整体升为 `0.9.22`；合同 SHA 为 `1a07dde94d270676cde4e6f1e0af3dcc071f4efedbb66c866c06cd64b36a5d39`，本次复审后 OmniAuto 固定提交为 `0510999859e2e174cfa3cc4a8cc39e9170f92ec9`。

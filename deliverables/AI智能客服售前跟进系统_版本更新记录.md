...
1. `AI智能客服售前跟进系统_PRD_运营后台统一版_v0.5.6.md`
2. `AI智能客服售前跟进系统_技术方案手册_v0.8.10.md`
3. 本版本更新记录
4. `AI智能客服售前跟进系统_全流程图_v0.3.puml`
...
| 项目 | 当前值 |
|---|---|
| 隔离候选目录 | `/private/tmp/chejin-fast-uat-c95f30a` |
| 候选父基线 | `c95f30ae…` |
| 当前机器合同文件 | `3.13.2`；运行代码、生成 schema 与测试尚未同步，架构阻断 |
| 目标机器合同 | `3.13.2` |
| PRD | v0.5.6 |
| 技术方案 | v0.8.10 |
| 全流程图 | v0.3 源文件 |
| 发布状态 | 未提交、未推送、未打包、未恢复 Windows UAT |
